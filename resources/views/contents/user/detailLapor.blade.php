...
<section class="hero-section">
    ...
    <div class="card">
        <div class="card-body pb-1">
            ...
            <div class="mt-3">
                <div class="d-flex">
                    <img class="me-2 rounded" src="/assets/images/avatar/man.jpg" alt="Generic placeholder image"
                        height="32">
                    <div>
                        <h5 class="m-0">{{$pengaduan->tanggapan->petugas->nama_petugas }} </h5>
                        <p class="text-muted mb-0"><small>{{ optional($pengaduan->tanggapan->tgl_tanggapan)->format('H:i') }}</small></p>
                ...
                {{-- <div class="d-flex mb-2">
                    ...
                    @elseif(Auth::guard('masyarakat')->user()->gender == 'perempuan')
                    <img src="/assets/images/avatar/girl.jpg" class="align-self-start rounded me-2" alt="..." height="32">
                    @elseif(Auth::guard('masyarakat')->user()->gender == 'laki_laki')
                    <img src="/assets/images/avatar/man.jpg" class="align-self-start rounded me-2" alt="..." height="32">
                    @endif
                    <div class="w-100">
