...
class UserController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        return view('contents.user.dashboard', compact('title', 'masyarakat', 'foto'));
    }
    ...
    public function storePengaduan(Request $request)
    {
        ...
        return redirect()->route('pekat.laporan')->with('message', "Laporan berhasil terkirim!");
    }

    public function edit($id)
    {
        $judul_laporan = Pengaduan::where('judul_laporan', Auth::guard('masyarakat')->user()->judul_laporan);
        $pengaduan = Pengaduan::where('nik', Auth::guard('masyarakat')->user()->nik)->first();
        $title = 'Home';      
    ...
    public function laporan()
    {
        ...
        return view('contents.user.laporan', ['pengaduan' => $pengaduan], compact('title', 'status', 'masyarakat', 'foto'));
    }
    ...
    public function detail($id)
    {
        ...
        $title = 'Home';      
        return view('contents.user.detailLapor', compact('pengaduan', 'title', 'tanggapan'));
    }
    ...
    public function deleteimg($id)
    {
        ...
        return redirect()->route('pekat.detailLaporan')->with('success','Petugas berhasil dihapus');
    }
}